...
export default function Signup() {
  ...
  const handleSignup = (e) => {
    ...
    setLoading(true);
    // Fake signup for now — backend comes in Phase 2
    setTimeout(() => {
      setLoading(false);
      navigate("/dashboard");
    }, 1000);
    ...
    <div className="flex h-screen">
      ...
      >
        <div className="flex items-center gap-3 mb-10">
          <div
            className="w-12 h-12 rounded-xl flex items-center justify-center text-2xl font-semibold text-white"
        ...
        <p
          className="text-white text-center text-sm mb-10"
          style={{ opacity: 0.75 }}
        >
          Join thousands of teams who manage their work with FlowBoard.
        </p>
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-8 bg-white">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-center text-gray-500 mt-6">
            ...
            <Link to="/" className="font-medium" style={{ color: "#a855f7" }}>
              Sign in
            </Link>
          </p>
